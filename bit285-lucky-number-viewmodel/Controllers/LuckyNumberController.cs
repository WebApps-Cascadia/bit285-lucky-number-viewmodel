...
namespace bit285_lucky_number_database.Controllers
{
    public class LuckyNumberController : Controller
    {
        ...
        public ActionResult Spin()
        {
            ...
            SpinViewModel mySpin = new SpinViewModel { Balance = currentPlayer.Balance, Number = currentPlayer.Number };
     ...
     //             return currentPlayer.Balance <= 0 ? "GAME OVER" : "";
      //       }
       //   }
